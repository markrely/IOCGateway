$(document).ready(function(){
 var $changePassword = $("#changePassword-page"),
     ...
     $passwordContainer = $changePassword.find(".userPassword"),
 ...
 else if($changePassword.find('input[type="password"][name=newpassword]').val().trim() == "" || !checkPasswordStrength($changePassword.find('input[type="password"][name=newpassword]').val().trim()))//we have to refer to the complete path to get the latest value
 {
